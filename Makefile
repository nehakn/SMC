...
SOURCES = \
	__init__.py \
	soil_moisture.py soil_moisture_dialog.py

PLUGINNAME = soil_moisture

PY_FILES = \
	__init__.py \
	soil_moisture.py soil_moisture_dialog.py

UI_FILES = soil_moisture_dialog_base.ui
...
QGISDIR=C:\Users\control\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
