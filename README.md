...
## Q-DAI plugin: Operations in the SMC tab (Soil moisture (SMC) product upload, SMC extraction for the target area and SMC computation at high resolution using DisPATCh algorithm
)
